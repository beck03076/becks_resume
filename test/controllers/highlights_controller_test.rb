...
class HighlightsControllerTest < ActionController::TestCase
  ...
  test "should create highlight" do
    assert_difference('Highlight.count') do
      post :create, highlight: { created_by: @highlight.created_by, desc: @highlight.desc, link: @highlight.link, name: @highlight.name, user_id: @highlight.user_id }
    end
  ...
  test "should update highlight" do
    patch :update, id: @highlight, highlight: { created_by: @highlight.created_by, desc: @highlight.desc, link: @highlight.link, name: @highlight.name, user_id: @highlight.user_id }
    assert_redirected_to highlight_path(assigns(:highlight))
  end
